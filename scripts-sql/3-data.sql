...
ALTER TABLE categorie ALTER COLUMN IdCategorie RESTART WITH 10;
...
INSERT INTO lettre (IdLettre, Titre,IdCompte) VALUES
  (1, 'Flash Info',1),
  (2, 'Actus du mois',2);

ALTER TABLE lettre ALTER COLUMN idlettre RESTART WITH 3;

INSERT INTO abonner (IdLettre,IdCategorie) VALUES
  (2,1),
  (2, 2);
